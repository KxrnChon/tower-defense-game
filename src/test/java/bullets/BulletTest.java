...
public class BulletTest {
    ...
    void testConstructor() {
        Bullet bullet = new Bullet(10,20,enemy,100,10);
    ...
    @Test
    void testTargetNull() {
        Bullet bullet = new Bullet(0,0,null,100,10);
    ...
    void testBulletMovesTowardEnemy() {
        Bullet bullet = new Bullet(-50,0,enemy,100,10);
    ...
    void testBulletHitsEnemy() {
        Bullet bullet = new Bullet(20,20,enemy,100,10);

        int hpBefore = enemy.getHp();

        // ทำให้ bullet เดินทางไกลพอ
        for(int i=0;i<20;i++){
            bullet.update(0.016);
        }
